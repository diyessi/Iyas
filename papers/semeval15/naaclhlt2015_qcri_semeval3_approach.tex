...
similarity between the vocabulary intersection between $q$ and $c$ is 
considered. In this case, the weight associated to each word is its tf-idf.
...
Lexicon v.0.1~\cite{MohammadKZ2013}.%
\footnote{\url{
...
Even if these features seem to fit with task A, more than B, at development 
