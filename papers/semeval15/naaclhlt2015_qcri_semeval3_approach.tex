...
indicators that trigger a \good or \bad class, regardless of the specific 
question it intends to reply to. 
Our aim is capturing those words which are associated to questions and comments 
in the different classes. 

Our features include $n$-grams, independently obtained from question and 
