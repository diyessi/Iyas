...
\red{(?)}. The one-versus-all approach has been used to account for the fact 
...
The first contrastive submission adds the Partial tree kernel \blue{According 
to the last Massimo email, PTK is not used. Please, confirm}. Its parameters 
