...
public class FeaturesTester {
	private static final String text = "This is a test text with an email@domain.com";
	...
	public static void main(String[] args) throws UIMAException{
		...
		AnalysisEngine lowercaseAnnotator = AnalysisEngineFactory
				.createEngine(createEngineDescription(EmailAnnotator.class,
						EmailAnnotator.PARAM_LANGUAGE, "en"));
		 ...
		 */	
		Map<Token, Collection<Email>> token2Lowercase =
				JCasUtil.indexCovering(cas, Token.class, Email.class);
