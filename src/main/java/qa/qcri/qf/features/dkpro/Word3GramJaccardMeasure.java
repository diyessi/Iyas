...
public class Word3GramJaccardMeasure implements PairFeature {

	public static final String NAME = "Word3GramJaccardMeasure";
	...
	public Word3GramJaccardMeasure(List<RichTokenNode> aTokens,
